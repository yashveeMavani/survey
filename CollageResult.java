...
public class CollageResult extends JFrame
{
	TextField t1,t2,t3,t4,t5,t6;
	Button l1,l2,l3,l4,l5,b1;
	MyActionListener cor = new MyActionListener(this);
	CollageResult()
	{
		super("java project");
		setLayout(null);
		...
		l1 = new Button("Marwadi University");
		l2 = new Button("VVP");
		l3 = new Button("T.N.RAO");
		l4 = new Button("Darshan University");
		l5 = new Button("Rk University");
		t2 = new TextField();
		t3 = new TextField();
		t4 = new TextField();
		t5 = new TextField();
	...
	{
			CollageResult cor = new CollageResult();
			cor.setVisible(true);
