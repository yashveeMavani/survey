...
public class BiscuitResult extends JFrame
{
	TextField t1,t2,t3,t4,t5,t6;
	Button l1,l2,l3,l4,l5,b1;
	MyActionListener br = new MyActionListener(this);
	BiscuitResult()
	{
		super("java project");
		setLayout(null);
		...
		l1 = new Button("Oreo");
		l2 = new Button("Kreck jeck");
		l3 = new Button("Marigold");
		l4 = new Button("Hide and Seek");
		l5 = new Button("Bourbon");
		t2 = new TextField();
		t3 = new TextField();
		t4 = new TextField();
		t5 = new TextField();
	...
	{
			BiscuitResult br = new BiscuitResult();
			br.setVisible(true);
