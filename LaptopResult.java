...
public class LaptopResult extends JFrame
{
	TextField t1,t2,t3,t4,t5,t6;
	Button l1,l2,l3,l4,l5,b1;
	MyActionListener lr = new MyActionListener(this);
	LaptopResult()
	{
		super("java project");
		setLayout(null);
	...
	{
			LaptopResult lr = new LaptopResult();
			lr.setVisible(true);
