...
public class MobileResult extends JFrame
{
	TextField t1,t2,t3,t4,t5,t6;
	Button l1,l2,l3,l4,l5,b1;
	MyActionListener mr = new MyActionListener(this);
	MobileResult()
	{
		super("java project");
		setLayout(null);
		...
		l1 = new Button("One plus");
		l2 = new Button("Redmi");
		l3 = new Button("Samsung");
		l4 = new Button("oop");
		l5 = new Button("vivo");
		t2 = new TextField();
		t3 = new TextField();
